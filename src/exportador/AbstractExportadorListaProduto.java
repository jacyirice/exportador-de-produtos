...
public abstract class AbstractExportadorListaProduto implements ExportadorListaProduto {
     ...
     */
    protected static final List<String> TITULOS_COLUNAS = Arrays.asList("ID", "Descrição", "Marca", "Modelo",
            "Estoque");
    ...
    /**
     * Gera o texto representando todas as linhas de uma tabela (em um formato
     * definido pelas subclasses)
     * contendo os dados dos produtos na lista de produtos.
     *
     * @param sb            {@link StringBuilder} onde o texto gerado será
     *                      adicionado
     * @param listaProdutos
     */
    private void gerarLinhasProdutos(StringBuilder sb, List<Produto> listaProdutos) {
        for (Produto produto : listaProdutos) {
            List<String> valoresCamposProduto = Arrays.asList(String.valueOf(produto.getId()),
    ...
    /**
     * Gera o texto representando uma única linha de uma tabela (em um formato
     * definido pelas subclasses).
     *
     * @param valores valores a serem exibidos nas colunas, que podem ser:
     *                (i) os títulos das colunas (caso esteja sendo gerada a linha
     *                de cabeçalho da tabela) ou
     *                (ii) os valores de uma linha da tabela (caso esteja sendo
     *                gerado uma linha de conteúdo da tabela).
     *                Neste último caso, tal parâmetro deve conter os valores dos
     *                atributos de um objeto da lista de produtos.
